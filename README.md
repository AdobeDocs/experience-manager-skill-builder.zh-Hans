...
该项目采用了[Adobe Open Source行为准则](code-of-conduct.md)或[.NET Foundation行为准则](https://dotnetfoundation.org/about/policies/code-of-conduct)。 有关详细信息，请参阅[参与](contributing.md)一文。
...
希望撰写新文章或提出重大更新建议的Adobe社区成员应通过通过Git存储库的“问题”选项卡提交问题，并打开与文档团队的对话来启动此流程。 在您同意了计划后，请与员工合作，通过公共和专用存储库中的工作组合来帮助引入新内容。
...
负责创建Adobe Experience Cloud文档的技术作家、项目经理和开发人员应通过`https://git.corp.adobe.com/AdobeDocs`上的专用存储库进行投稿。
...
* [Markdown基础](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github)
* [可打印的Markdown速查表](https://enterprise.github.com/downloads/en/markdown-cheatsheet.pdf)
